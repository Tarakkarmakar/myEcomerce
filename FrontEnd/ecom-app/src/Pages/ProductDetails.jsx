...
const ProductDetails = () => {
  ...
  const getSimilarProduct = async (pid, cid) => {
    try {
      const { data } = await axios.get(
        `https://alive-hare-cape.cyclic.app/v1/product/related-product/${pid}/${cid}`
      );
    ...
    <Layout>
      <div className="row container mt-4">
        <div className="col-md-6">
          <img
            src={`https://alive-hare-cape.cyclic.app/api/v1/product/product-photo/${product._id}`}
      ...
      <div className="row container mt-4 mb-4">
        ...
        {relatedProduct.length < 1 && (
          <h4 className="text-center">No Similar Books Found😞</h4>
        )}
